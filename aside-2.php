<div  id="menu">
    <div class="vertical-menu">
        <div class="col-12 col-md-12 col-lg-12" id="menu2">
            <div class="logo-lupa">
                <img class="logo-lupa" src="images/busca_casa.png">
            </div>
            <br>
            <form action="casas_user.php" method="post">
            ...
            <div class="text-center">
                <div id="sfcpmytr8gf26efxct5e5t4e8dnwjmzdn42"></div>
                <script type="text/javascript" src="https://counter5.wheredoyoucomefrom.ovh/private/counter.js?c=pmytr8gf26efxct5e5t4e8dnwjmzdn42&down=async" async></script>
                <label for="visi" id="visi">Visitas: </label><img src="https://counter5.wheredoyoucomefrom.ovh/private/contadorvisitasgratis.php?c=pmytr8gf26efxct5e5t4e8dnwjmzdn42" border="0" title="contador de visitas gratis" alt="contador de visitas gratis"></a>
                </noscript>
            </div>
        </div>
    </div>
